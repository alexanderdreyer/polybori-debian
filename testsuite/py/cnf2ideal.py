...
parser.add_option("-f", "--format",
                  ...
                  choices=[ALL,MAGMA,SING,PB,SLIM,MAPLE,MATHEMATICA],default=PB,
...
#    print clauses
    ...
    out.close()
def  convert_file_symmGB_F2_python(clauses,cnf,invert):
  return convert_file_Singular(clauses,cnf,invert,alg="symmGB_F2_python")
...
converters={PB:convert_file_PB,SING:convert_file_Singular,MAGMA:convert_file_Magma,MATHEMATICA:convert_file_Mathematica,SLIM:convert_file_symmGB_F2_python,MAPLE:convert_file_Maple}
